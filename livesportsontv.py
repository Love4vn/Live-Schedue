...
# Final fix: tennis tournament name from div.event_participant--home, channels from aria-label
        ...
        for league_name, config in leagues_config.items():
            ...
            for row in rows:
                try:
                    ...
                    # Channels - from ul.event_tags, each a has aria-label
                    channels = []
                    ...
                    # If still no channels, try other container
                    if not channels:
