...
# ================================================
# SCRIPT LẤY LỊCH TRẬN BÓNG ĐÁ & TENNIS (5 NGUỒN) – FINAL FIX 12
# ================================================
...
def is_women_youth(title):
    """Kiểm tra title có chứa từ khóa nữ/trẻ hay không, sử dụng word boundary để tránh nhầm chữ 'b' trong tên đội."""
    t = title.lower()
